...
(function ( Popcorn ) {
  ...
  Popcorn.plugin( "subtitle" , {
      ...
      var id = parseInt(options.innerContainer.id.replace("subtitle-",""))+1;
       socket.emit("subStart", {session:app.session,subId:id, text:options.text});
      //////////////////////////////////////////////////////////////////////////////
       ...
       */
        ...
        var id = parseInt(options.innerContainer.id.replace("subtitle-",""))+1;
       socket.emit("subStop", {session:app.session,subId:id, text:options.text});
      },
